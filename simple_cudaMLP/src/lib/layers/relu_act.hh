...
// kernel - calculate relu output for each item in input matrix
...
// kernel - calculate relu derivative output for each item in input error matrix
...
public:
    ...
    Matrix &forward(Matrix &input)
    {
        ...
        dim3 block_size(256); // we just need a 1D block for this
